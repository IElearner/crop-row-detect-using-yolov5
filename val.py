...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default='data/crop_row-seg.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default='weights_train/weights_2/threehead/classicconv/CIOU/CBAM/best.pt', help='model path(s)')
